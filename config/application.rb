require 'origen'
class ATDTestApplication < Origen::Application
  ...
  self.name       = "atd_test"
  self.namespace  = "ATDTest"
  config.name     = "atd_test"
  config.initials = "ATDTest"
  # Change this to point to the revision control repository for this application
  config.rc_url = "git@github.com:Origen-Demos/1-pattern-in-20-minutes.git"
  # To enable deployment of your documentation to a web server (via the 'origen web'
  # command) fill in these attributes.
  #config.web_directory = "/path/to/server/atd_test"
  #config.web_domain = "http://origen.mycompany.net/atd_test"
